...
public class TestDB {
	...
	public static void main(String[] args) throws ParseException {
		...
		// db.abfrageEinfach04(false, "Unternehmens- und
		...
		// db.abfrageKomplex03("Unternehmens- und Wirtschaftsinformatik",
		// "Donnerstag");
		...
		// db.abfrageKomplex11("DM", "Unternehmens- und Wirtschaftsinformatik",
		// "Dopatka");
		...
		// db.insertPerson("testvorname07","testnachname03", "2011-09-08" ,
		// true);
		// db.insertDozent("tst", 4, 25);
		// db.insertStudierender(4, 1, 28);
		...
		// db.updatePerson("testv1","testn", "2011-09-08", false, 25);
		// db.updateDozent("TED", 5, 25, 9);
		// db.updateFakultaet("Test Fakultät02", 11);
		// db.updateStudierender(4, 1, 30, 1811429);
		// db.updateStudiengang("Test Studiengang",7);
		// db.updateVeranstaltung(2, 90, 9, 101,2, 29);
		// db.updateVeranstaltungsname("test Veranstaltung01", "T1",14);
		// db.updateRaum(false, "t001");

		/*
		 * Ergibt keinen Sinn bei den Tabellen ein Update zu machen
		 * db.updateHoert(28, 1667722); db.updateHat("H0807", 100);
		 * db.updateErhaelt(10, 58); db.updateBesitzt(99, 1644557);
		 */
